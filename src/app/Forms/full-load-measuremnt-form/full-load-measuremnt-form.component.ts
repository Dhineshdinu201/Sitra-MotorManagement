...
@Component({
  selector: 'app-full-load-measuremnt-form',
  templateUrl: './full-load-measuremnt-form.component.html',
  styleUrls: ['./full-load-measuremnt-form.component.css']
})
export class FullLoadMeasuremntFormComponent implements OnInit {
  masterDataForm: any;
